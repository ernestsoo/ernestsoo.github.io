...
app.controller("formControl", function ($scope, $http,$interval,$window) {
       ...
       // alert("hi2");
        ...
        $scope.disableNameWarning = function()
        {
            $scope.warningNameShow = false;
        }
        ...
        $scope.disableWeightWarning = function()
        {
            $scope.warningWeightShow = false;
        }
    ...
    {   
     // alert ("hi");
        ...
        else 
        {
         ...
         /*** Checking for Name ***/
         $window.formstat2a = $scope.regform2.first.$valid;
         $window.formstat2b = $scope.regform2.last.$valid;


        if($scope.warningNameShow && !$scope.regform2.first.$valid)
        {
            $window.regnameA= true ;
        }
        else
        {
            $window.regnameA= false ;
        }
        ...
        /*** Checking for Weight ***/
        $window.formstat5 = $scope.regform5.weight.$valid;
   ...
   //    $scope.indexShow = $routeParams.index;
    ...
    for(var i = 0; i<$scope.calenderevents.length; i++)
    {
        ...
        else
        {
            ...
            {
            // 0 in front of month
        string='"'+$scope.calenderevents[i].year+'-0'+$scope.calenderevents[i].month+'-12":{"number":'+$scope.calenderevents[i].number+'}';
            }
            else
            {
